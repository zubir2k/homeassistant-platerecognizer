...
class PlateRecognizerOptionsFlow(OptionsFlow):
    ...
    async def async_step_init(
        ...
        # Merge base data with any previously saved options so defaults are pre-populated
        current = {**self.config_entry.data, **self.config_entry.options}

        # Lists are stored as real lists; convert to comma-separated strings for the text fields
